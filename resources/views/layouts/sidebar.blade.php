<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            {{-- <li class="active"><a href="{{ url('/laporanProdukMasuk') }}"><i class="fa fa-file-text"></i> <span>Laporan</span></a></li> --}}
            <li class="active"><a href="{{ url('/laporanProdukKeluar') }}"><i class="fa fa-file-text-o"></i> <span>Laporan</span></a></li>
