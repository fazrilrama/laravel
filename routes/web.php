...
Route::group(['middleware' => 'auth'], function () {
	...
	// Route::resource('laporan', 'LaporanMasukController');
	
	// Produk Masuk
	Route::get('/laporanProdukMasuk', 'LaporanMasukController@index');
	Route::get('/pdfProdukSupplier/{id}', 'LaporanMasukController@pdfSupplier');
	Route::get('/pdfProdukBulan/{id}', 'LaporanMasukController@pdfBulan');
	Route::get('/ExcelMasukSupplier/{id}', 'LaporanMasukController@excelSupplier');
	// Filter
	Route::get('bulan/{id}', 'LaporanMasukController@bulan');
	Route::get('supplier/{id}', 'LaporanMasukController@supplier');
	
	// Produk Keluar
	Route::get('/laporanProdukKeluar', 'LaporanKeluarController@index');
	Route::get('pdfKeluarCustomer/{id}', 'LaporanKeluarController@pdfCustomer');
	Route::get('pdfKeluarBulan/{id}', 'LaporanKeluarController@pdfBulan');
	// filter
	Route::get('bulans/{id}', 'LaporanKeluarController@bulan');
	Route::get('customer/{id}', 'LaporanKeluarController@costumer');
	Route::get('hari/{id}', 'LaporanKeluarController@hari');
	Route::get('pdfKeluarhari/{id}', 'LaporanKeluarController@pdfHari');
	Route::get('pdfKeluarbulan/{id}', 'LaporanKeluarController@pdfBulan');

	Route::get('/LaporanProdukKeluar', 'LaporanController@LaporanProdukKeluar');
